...
class Solution(object):
    ...
    # values at the points x_plot, y_plot.
    def plot(self, x_plot, y_plot, elems_plot, values_plot):
    ...
    # orders).
    def convert_to_triangles(x, y, elems, orders):
        tria_elems = []
        tria_orders = []
    ...
    def offset_node_indices(offset, elems):
        for elem in elems:
    ...
    def create_plotting_mesh(self):
        ...
        elems, orders = convert_to_triangles(x, y, self._mesh.elems, self._mesh.orders)
